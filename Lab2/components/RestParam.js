    ...
    return (
      <View style={styles.rest.container}>
        <View style={styles.rest.text}>
          ...
          <Text style={styles.rest.optxt}>Składnia ta pozwala funkcji na przyjmowanie wielu parametów. 
          Zapewnia sposób reprezentowania funkcji wariadycznych w JavaScript.</Text>
          </View>
          <View style={styles.rest.ex}>
            <Text style={styles.rest.extxt1}>Niezły przykładzik:</Text>
